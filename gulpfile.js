...
let paths = {
	...
	scripts: {
		src: [
			...
			'node_modules/micromodal/dist/micromodal.min.js', //npm install micromodal --save
			'node_modules/inputmask/dist/jquery.inputmask.min.js',	//npm install inputmask --save
